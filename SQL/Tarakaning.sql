...
-- Дата скрипта: 10.10.2011 2:31:45
...
INSERT INTO DefectItem VALUES 
  ...
  (89, 'Major', '0'),
  (90, 'Major', 'Действия:<br />\r\n<br />\r\n1. Первое действие<br />\r\n2. Второе действие<br />\r\n3. Третье действие'),
...
INSERT INTO ErrorReport VALUES 
  ...
  (76, 1, 48, 'Defect', '0', 'NEW', '2011-10-06 02:52:31', 'В комментариях у грида не подсвечивается текущее поле, по которому сортируем', 'Поле грида, по которому сортируем, должно выделяться в красный цвет.', 1),
  ...
  (81, 1, 22, 'Task', '1', 'NEW', '2011-10-06 22:04:06', 'Пагинатор и сортировщик грида для &quot;Отображение заявок на проект&quot;', 'Добавить пагинатор и сортировщик грида для показываемых заявок. Сортировать по полям:\r\n* Пользователь\r\n* Дата', 18),
  (82, 1, 48, 'Task', '2', 'NEW', '2011-10-06 22:08:45', 'Поиск проектов', 'Реализовать полнотекстовый поиск по проекту и его описанию. На первом месте должны находиться проекты более совпадающие с поисковым критерием. \r\n\r\nПри удалении проекта - удалять полнотекстовый индекс проекта. Если у проекта пользователь был удалён, то ото', 18),
  ...
  (89, 1, 22, 'Defect', '2', 'NEW', '2011-10-09 14:00:42', 'Тестовый вариант', '0', NULL),
  (90, 1, 22, 'Defect', '2', 'NEW', '2011-10-09 14:01:57', 'Тестовый вариант', 'Описание:<br />\r\n<br />\r\n1. Описание<br />\r\n2. Описание<br />\r\n3. Описание', NULL),
  ...
  (93, 1, 22, 'Task', '1', 'NEW', '2011-10-10 00:00:42', 'Копальщик', 'Копай копалово', NULL),
  (96, 1, 22, 'Task', '1', 'NEW', '2011-10-10 00:10:53', 'прпарпа', '', 0),
  ...
  (100, 1, 22, 'Task', '1', 'NEW', '2011-10-10 00:18:01', 'рапрвапр', 'варпаврпавра', 0),
  ...
  (104, 15, 22, 'Task', '1', 'NEW', '2011-10-10 00:24:37', 'рпопропро', '', 7),
  (105, 15, 22, 'Task', '1', 'NEW', '2011-10-10 00:24:48', 'ролпролпролпрол', 'роарорлор', 0),
...
INSERT INTO ReportComment VALUES 
  ...
  (40, 32, 1, '2011-10-06 23:36:18', ''),
  (41, 32, 1, '2011-10-06 23:36:20', ''),
  (42, 32, 1, '2011-10-06 23:36:22', ''),
  (43, 32, 1, '2011-10-06 23:36:25', ''),
  (44, 32, 1, '2011-10-06 23:36:29', ''),
  (45, 32, 1, '2011-10-06 23:36:30', ''),
  (46, 32, 1, '2011-10-06 23:36:33', ''),
  (47, 32, 1, '2011-10-06 23:36:35', ''),
  (48, 32, 1, '2011-10-06 23:36:37', ''),
  (49, 32, 1, '2011-10-06 23:36:42', ''),
  (50, 32, 1, '2011-10-06 23:36:48', ''),
  (51, 32, 1, '2011-10-06 23:37:08', ''),
  (52, 32, 1, '2011-10-06 23:37:56', ''),
