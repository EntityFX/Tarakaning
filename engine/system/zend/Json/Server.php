 ...
 */
require_once 'engine/system/zend/Server/Abstract.php';
...
class Zend_Json_Server extends Zend_Server_Abstract
{
    ...
    public function addFunction($function, $namespace = '')
    {
        if (!is_string($function) && (!is_array($function) || (2 > count($function)))) {
            require_once 'engine/system/zend/Json/Server/Exception.php';
        ...
        require_once 'engine/system/zend/Server/Reflection.php';
    ...
    {
        require_once 'engine/system/zend/Json/Server/Error.php';
    ...
    public function getRequest()
    {
        if (null === ($request = $this->_request)) {
            require_once 'engine/system/zend/Json/Server/Request/Http.php';
    ...
    public function getResponse()
    {
        if (null === ($response = $this->_response)) {
            require_once 'engine/system/zend/Json/Server/Response/Http.php';
    ...
    public function getServiceMap()
    {
        if (null === $this->_serviceMap) {
            require_once 'engine/system/zend/Json/Server/Smd.php';
