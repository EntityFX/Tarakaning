 ...
 * @see Zend_Json_Expr
 */
require_once 'engine/system/zend/Json/Expr.php';
...
class Zend_Json
{
    ...
    public static function decode($encodedValue, $objectDecodeType = Zend_Json::TYPE_ARRAY)
    {
        ...
        if (function_exists('json_decode') && self::$useBuiltinEncoderDecoder !== true) {
            ...
            if (!function_exists('json_last_error')) {
                if ($decode === $encodedValue) {
                    require_once 'engine/system/zend/Json/Exception.php';
        ...
        require_once 'engine/system/zend/Json/Decoder.php';
    ...
    public static function encode($valueToEncode, $cycleCheck = false, $options = array())
    {
        ...
        if(isset($options['enableJsonExprFinder'])
           && ($options['enableJsonExprFinder'] == true)
             ...
             */
            require_once "engine/system/zend/Json/Encoder.php";
