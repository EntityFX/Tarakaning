 ...
 */
require_once 'engine/system/zend/Locale/Format.php';
...
class Zend_Validate_PostCode extends Zend_Validate_Abstract
{
    ...
    public function __construct($options = null)
    {
        ...
        if (empty($options)) {
            require_once 'engine/system/zend/Registry.php';
        ...
        if (empty($format)) {
            require_once 'engine/system/zend/Validate/Exception.php';
    ...
    {
        require_once 'engine/system/zend/Locale.php';
