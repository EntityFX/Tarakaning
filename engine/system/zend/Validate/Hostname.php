 ...
 */
require_once 'engine/system/zend/Validate/Abstract.php';

/**
 * @see Zend_Validate_Ip
 */
require_once 'engine/system/zend/Validate/Ip.php';
...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'engine/system/zend/Validate/Hostname/Com.php',
        ...
        'HK'  => 'engine/system/zend/Validate/Hostname/Cn.php',
        ...
        'JP'  => 'engine/system/zend/Validate/Hostname/Jp.php',
        ...
        'NET' => 'engine/system/zend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => 'engine/system/zend/Validate/Hostname/Com.php',
        ...
        'TW'  => 'engine/system/zend/Validate/Hostname/Cn.php',
        ...
        '中国' => 'engine/system/zend/Validate/Hostname/Cn.php',
        '公司' => 'engine/system/zend/Validate/Hostname/Cn.php',
        '网络' => 'engine/system/zend/Validate/Hostname/Cn.php'
    );
