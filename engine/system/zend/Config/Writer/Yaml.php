 ...
 */
require_once 'engine/system/zend/Config/Writer/FileAbstract.php';

/**
 * @see Zend_Config_Yaml
 */
require_once 'engine/system/zend/Config/Yaml.php';
...
class Zend_Config_Writer_Yaml extends Zend_Config_Writer_FileAbstract
{
    ...
    public function setYamlEncoder($yamlEncoder)
    {
        if (!is_callable($yamlEncoder)) {
            require_once 'engine/system/zend/Config/Exception.php';
