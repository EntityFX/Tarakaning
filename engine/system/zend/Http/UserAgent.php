...
class Zend_Http_UserAgent implements Serializable
{
    ...
    public function setOptions($options)
    {
        ...
        if (!is_array($options)
            ...
            require_once 'engine/system/zend/Http/UserAgent/Exception.php';
    ...
    public function setPluginLoader($type, $loader)
    {
        ...
        $basePath   = 'engine/system/zend/Http/UserAgent/';
        switch ($type) {
            case 'storage':
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!isset($this->_loaders[$type])) {
            require_once 'engine/system/zend/Loader/PluginLoader.php';
