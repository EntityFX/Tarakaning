...
require_once 'engine/system/zend/Http/UserAgent/AbstractDevice.php';
...
class Zend_Http_UserAgent_Mobile extends Zend_Http_UserAgent_AbstractDevice
{
    ...
    const DEFAULT_FEATURES_ADAPTER_PATH = 'engine/system/zend/Http/UserAgent/Features/Adapter/WurflApi.php';
