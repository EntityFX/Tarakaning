 ...
 * @see Zend_Loader
 */
require_once 'engine/system/zend/Loader.php';


/**
 * @see Zend_Uri
 */
require_once 'engine/system/zend/Uri.php';


/**
 * @see Zend_Http_Client_Adapter_Interface
 */
require_once 'engine/system/zend/Http/Client/Adapter/Interface.php';


/**
 * @see Zend_Http_Response
 */
require_once 'engine/system/zend/Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once 'engine/system/zend/Http/Response/Stream.php';
...
class Zend_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof Zend_Uri_Http) {
            ...
            require_once 'engine/system/zend/Http/Client/Exception.php';
